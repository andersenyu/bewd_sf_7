...
categories.insert(3, "You")
assert_equal ["Florida", "Music", "Weather", "You"], categories.sort
...
assert_equal("Animals, Family, Florida, Music, Shopping, Weather, You", categories.sort!.join(', '))
assert_equal(%w(Animals Family Florida Music Shopping Weather You), categories)
